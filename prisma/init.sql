-- Create user
CREATE USER mismat WITH PASSWORD '5!4sC5ackerS';
...
-- Name: mismat_dev; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE mismat_dev WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C';

ALTER DATABASE mismat_dev OWNER TO mismat;
...
ALTER SCHEMA base OWNER TO mismat;
...
ALTER TABLE base."Character" OWNER TO mismat;
...
ALTER SEQUENCE base."Character_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Encounter" OWNER TO mismat;
...
ALTER TABLE base."EncounterInstance" OWNER TO mismat;
...
ALTER SEQUENCE base."EncounterInstance_id_seq" OWNER TO mismat;
...
ALTER SEQUENCE base."Encounter_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Event" OWNER TO mismat;
...
ALTER SEQUENCE base."Event_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Item" OWNER TO mismat;
...
ALTER SEQUENCE base."Item_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Location" OWNER TO mismat;
...
ALTER SEQUENCE base."Location_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Magic" OWNER TO mismat;
...
ALTER SEQUENCE base."Magic_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Monster" OWNER TO mismat;
...
ALTER SEQUENCE base."Monster_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Path" OWNER TO mismat;
...
ALTER TABLE base."PathInstance" OWNER TO mismat;
...
ALTER SEQUENCE base."PathInstance_id_seq" OWNER TO mismat;
...
ALTER SEQUENCE base."Path_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Relationship" OWNER TO mismat;
...
ALTER SEQUENCE base."Relationship_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Scenario" OWNER TO mismat;
...
ALTER SEQUENCE base."Scenario_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Spell" OWNER TO mismat;
...
ALTER SEQUENCE base."Spell_id_seq" OWNER TO mismat;
...
ALTER TABLE base."Thread" OWNER TO mismat;
...
ALTER SEQUENCE base."Thread_id_seq" OWNER TO mismat;
...
ALTER TABLE base."_CharacterToItem" OWNER TO mismat;
...
ALTER TABLE base."_CharacterToScenario" OWNER TO mismat;
...
ALTER TABLE base."_EncounterToScenario" OWNER TO mismat;
...
ALTER TABLE base."_ItemToScenario" OWNER TO mismat;
...
ALTER TABLE base."_LocationToScenario" OWNER TO mismat;
...
ALTER TABLE base."_MagicToScenario" OWNER TO mismat;
...
ALTER TABLE base._prisma_migrations OWNER TO mismat;
