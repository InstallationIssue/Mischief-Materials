  ...
  return (
    <div className="flex flex-col gap-2 p-1">
      <div className="flex flex-row gap-2 magics-center overflow-clip rounded-lg items-center font-header text-lg">
        {magic.medium == "magic" && (
          <MagicIcon className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "flame" && (
          <Flame className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "flask" && (
          <Flask className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "electricity" && (
          <Electricity className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "golem" && (
          <Golem className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "homunculus" && (
          <Homunculus className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "ice" && (
          <Ice className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "liquid" && (
          <Liquid className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "robot" && (
          <Robot className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "sick" && (
          <Sick className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "summon" && (
          <Summon className="h-8 w-8 fill-primary-light" />
        )}
        {magic.medium == "wind" && (
          <Wind className="h-8 w-8 fill-primary-light" />
        )}
