  ...
  return (
    <div className="p-1">
      <span className="flex flex-row items-center rounded justify-between w-full h-10">
        ...
        {data.icon == "boat" && (
          <Boat className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "building" && (
          <Building className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "campground" && (
          <Campground className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "city" && (
          <City className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "dungeon" && (
          <Dungeon className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "entrance" && (
          <Entrance className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "factory" && (
          <Factory className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "hideout" && (
          <Hideout className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "home" && (
          <Home className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "hospital" && (
          <Hospital className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "institution" && (
          <Institution className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "landmark" && (
          <Landmark className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "location" && (
          <LocationIcon className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "medical" && (
          <Medical className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "mountain" && (
          <Mountain className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "mountown" && (
          <Mountown className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "obelisk" && (
          <Obelisk className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "outpost" && (
          <Outpost className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "ship" && (
          <Ship className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "store" && (
          <Store className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "tent" && (
          <Tent className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "volcano" && (
          <Volcano className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "warehouse" && (
          <Warehouse className="h-full aspect-square fill-primary-light" />
        )}
        {data.icon == "worship" && (
          <Worship className="h-full aspect-square fill-primary-light" />
        )}
      </span>
