...
export default function Page() {
  ...
  return (
    <div className='flex flex-col items-center w-full relative'>
      <Link href='/' className='flex flex-row items-center absolute top-2 left-2 z-10'>
      ...
      <div className='flex relative overflow-clip w-full h-96 justify-center'>
        <Image 
          src={'/images/death-valley.png'} alt={'Image of Death Valley Desert'} 
          width={1940} height={1096}
          priority className='absolute object-cover -z-10 top-1/2 -m-[25%]'/>
