...
export default function Armor (){
    ...
    return (
        <div className="relative w-24 h-24 flex justify-center items-center">
            <svg viewBox="0 0 90 91" xmlns="http://www.w3.org/2000/svg" className="absolute">
                <circle cx="45" cy="45.2458" r="44" fill="#31313B" stroke="url(#paint0_angular_401_25877)" strokeWidth="2"/>
                <path d="M45.2117 21.1182L45.2278 21.1255L45.244 21.1324L64.6194 29.3538L64.6213 29.3546C66.3786 30.0974 67.6536 31.8147 67.6463 33.8517C67.5959 43.8157 63.4868 61.7536 46.5198 69.8777L46.5196 69.8778C45.2109 70.5047 43.6914 70.5047 42.3827 69.8778L42.3825 69.8777C25.4157 61.7537 21.3065 43.8161 21.256 33.852C21.2486 31.8149 22.5236 30.0975 24.281 29.3546L24.2826 29.3539L43.6683 21.1325L43.691 21.1228L43.7133 21.1125C43.933 21.0107 44.1906 20.9531 44.4512 20.9531C44.7093 20.9531 44.972 21.0098 45.2117 21.1182Z" fill="#F2F5EA" stroke="#2446DB" strokeWidth="3"/>
