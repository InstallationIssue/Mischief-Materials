...
export function PlayButton({ name, image }: { name: string; image: string }) {
  return (
    <Link
      className="flex flex-row items-center h-12 gap-2 bg-secondary-light transition active:text-highlight-light active:fill-highlight-light overflow-clip relative grow"
      href={"/play"}
    >
